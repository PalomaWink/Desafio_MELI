...
function checkBreads(ingredientsList) {
  //aqui preciso percorrer o ingredientList e 
  if (ingredientsList.filter((food) => food === breads)) 
}
...
function balancedBurgerScore(ingredientsList) {
  ...
  // Preciso percorrer todos os arrays e bater com o resultado da lista de compras, se true +1
  if () {
